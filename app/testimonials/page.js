                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="testimonial-1-block">
                                        ...
                                        <h4 className="testimonial-1-name">Guy Hawkins</h4>
                                        <p className="testimonial-1-designation">Manager</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="testimonial-1-block">
                                        ...
                                        <h4 className="testimonial-1-name">Robert Fox</h4>
                                        <p className="testimonial-1-designation">Manager</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="testimonial-1-block">
                                        ...
                                        <h4 className="testimonial-1-name">Annette Black</h4>
                                        <p className="testimonial-1-designation">Manager</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="testimonial-1-block">
                                        ...
                                        <h4 className="testimonial-1-name">Devon Lane</h4>
                                        <p className="testimonial-1-designation">Manager</p>
                                    </div>
                                </div>
                            </div>
